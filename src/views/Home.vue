  ...
  <div class="tudo">
    <div class="container">
      ...
      <div class="form">
        <div class="titulo1">
          <h1>
            2. Disponibilidade de equipamentos, máquinas e ferramentas para a
            realização do curso
          </h1>
        </div>
        <main class="pergunta1">
      ...
      <div class="form">
        <div class="titulo1">
          <h1>
            3. Qualidade de apostilas, livros e textos, quanto a impressão e a
      ...
      <div class="form">
        <div class="titulo1">
          <h1>13. Atendimento da Biblioteca</h1>
        </div>
        <main class="pergunta1">
          <section class="right-1">
            <div class="pg1">
      ...
      <div class="form">
        <div class="titulo1">
          <h1>
            Caso queira, insira abaixo comentários, sugestões ou reclamações:
          </h1>
        </div>
        <textarea
          class="box"
      ...
      <div class="form">
        <div class="titulo1">
          <h1>Deseja enviar seu formulário anonimamente?</h1>
          <main class="pergunta1">
            <section class="right-2">
              <div class="pg9" id="v-model-radiobutton">
                <div id="123">
                  <input type="radio" id="one" value="One" v-model="picked" />
